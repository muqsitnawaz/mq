...
func printUsage() {
	...
	fmt.Println("  .section(\"Name\")     Get section by heading (partial match)")
	...
	fmt.Println("")
	fmt.Println("  # Extract one section from a large file")
	fmt.Println("  mq GUIDE.md '.section(\"Testing\") | .text'")
	fmt.Println("")
	...
	fmt.Println("  mq report.pdf '.section(\"Results\") | .text'")
